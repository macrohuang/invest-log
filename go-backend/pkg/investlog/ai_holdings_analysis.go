...
func (c *Core) AnalyzeHoldings(req HoldingsAnalysisRequest) (*HoldingsAnalysisResult, error) {
	return c.analyzeHoldingsInternal(req, nil)
}
...
func (c *Core) AnalyzeHoldingsStream(req HoldingsAnalysisRequest, onDelta func(string) error) (*HoldingsAnalysisResult, error) {
	...
	return c.analyzeHoldingsInternal(req, onDelta)
}

func (c *Core) analyzeHoldingsInternal(req HoldingsAnalysisRequest, onDelta func(string) error) (*HoldingsAnalysisResult, error) {
