...
async def setup_submit(
    ...
    if storage_option == "custom" and custom_path:
        config.complete_setup(use_icloud=False, custom_data_dir=custom_path)
    elif use_icloud:
        config.complete_setup(use_icloud=True)
    else:
        # Default location
        config.complete_setup(use_icloud=False)
